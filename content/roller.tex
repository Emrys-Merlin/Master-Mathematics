...
\begin{proof}
  As we noted in Remark~\ref{rem:interval}, \(\mathcal{H}(\alpha,\beta) = \mathcal{H}([\alpha, \beta])\). Because of the Roller duality, it satisfies to work on the pocset of halfspaces. By Lemma~\ref{lem:b-1.16} we have the decomposition
  \[
    \mathcal{H}(\alpha, \beta) = P_1 \sqcup \dots \sqcup P_d.
  \]
