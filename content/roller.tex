...
\begin{proof}
  ...
  \item If \(\mathfrak{k} \in W^\ast\) we will find a contradiction. Indeed, we have \(\mathfrak{k}^\ast \subset \mathfrak{h}^\ast\) and \(W\) satisfies the consistency condition. Hence \(\mathfrak{h}^\ast \in W\). By the partial choice condition, we have \(\mathfrak{h} \not \in W\) which yields \(\mathfrak{h} \in \alpha' \subset \mathcal{H}'\). Hence, \(\mathfrak{h} \in W^\ast \cap \mathcal{H}' = \varnothing\) which is absurd.
  \end{enumerate}
