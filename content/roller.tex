...
\begin{proof}
  ...
  \end{align*}
  This map is well-defined and bijective. Next, let us show that it is continuous. Let \(\mathfrak{h}_i, \mathfrak{h'}_j\in \mathcal{H}(X)\), \(1\leq i\leq n\), \(1\leq j \leq m\) and set
  \[
