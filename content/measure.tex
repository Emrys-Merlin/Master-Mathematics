...
This chapter is divided in three sections. Section~\ref{sec:prob} collects general facts about measures, measure theory and functional analysis and is mainly without proofs. 
...
\begin{defin}[Signed and probability measures]
  ...
  \(B \in \Sigma\) is called \emph{null}, if \(\mu(S) = 0\) and \emph{conull} if its complement is null.
\end{defin}
