...
\begin{bsp}
  Figure~\ref{fig:hyperplanes} contains an example of a CAT(0) cube complex with an edge equivalence class of edges and associated hyperplane. 
  \begin{figure}[htbp]
    \centering
    \begin{tikzpicture}
      [scale=2]
      ...
      (2.5,0.5) -- (2.5,1.5);
    \end{tikzpicture}
    \caption{Example of a CAT(0) cube complex with a hyperplane inscribed. The darek blue edges form an edge equivalence class, which defines the blue hyperplane. The red and green parts indicate the two halfspaces associated to the hyperplane.}
