...
\begin{proof}[Sketch]
  By construction, it is easy to verify that the gluing of midcubes inherited from \(X\) gives \(\mathfrak{\hat h}\) a cube complex structure. Additionally, every convex closed subspace of a CAT(0) space is CAT(0) itself.
\end{proof}
