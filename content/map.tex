...
As stated above, we will decompose the pocset of halfspaces \(\mathcal{H}\) into two sets of pariwise transverse halfspaces. This leads to the desired product decomposition. First, we need another definition:
