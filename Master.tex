...
\title{Construction of a boundary map from a strong group boundary to the Roller boundary of a CAT(0) cube complex}
\author{Tim Adler}
\date{13.12.2017}
...
\lowertitleback{
\textbf{Construction of a boundary map from a strong group boundary to the Roller boundary of a CAT(0) cube complex}\\
