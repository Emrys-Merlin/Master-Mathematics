\documentclass[german,english,twoside,headsepline,titlepage=true,BCOR=10mm,final]{scrartcl} %final,draft,colorlinks=false
\input{header_std}
\input{header_math}
\input{header_artcl}
...
\hyphenation{one=to=one=cor-re-spon-dence}
\hyphenation{non=el-e-men-tary}
